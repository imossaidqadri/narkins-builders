...
interface ThreeBedroomApartmentsProps {
  properties: Property[]
...
export default function ThreeBedroomApartmentsBahriaTown({
  properties,
  posts,
}: ThreeBedroomApartmentsProps) {
  ...
  return (
    <main>
      <Head>
        <title>
          3 Bedroom Apartments Bahria Town Karachi | Ready & Pre-Launch Options
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="3 bedroom apartments Bahria Town, apartments for sale Bahria Town Karachi, ready apartments Bahria Town Karachi, apartments on installments Bahria Town, best apartments in Bahria Town Karachi, family apartments Bahria Town Karachi, luxury apartments Bahria Town, Hill Crest Residency Bahria Town, Narkin's Boutique Residency apartments"
        />
        <meta name="author" content="Narkin's Builders" />

        <link
          rel="canonical"
          href="https://www.narkinsbuilders.com/3-bedroom-apartments-bahria-town"
        />

        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="3 Bedroom Apartments Bahria Town Karachi | Ready & Pre-Launch Options"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.narkinsbuilders.com/3-bedroom-apartments-bahria-town"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="3 Bedroom Apartments Bahria Town Karachi | Ready & Pre-Launch"
        />
        <meta
      ...
      <div className="bg-white pt-[6rem]">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl tracking-tight text-black sm:text-6xl">
                3 Bedroom Apartments in Bahria Town Karachi
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Discover spacious 3 bedroom family apartments for sale in Bahria
                Town Karachi. From ready-to-move Hill Crest Residency to
                pre-launch Narkin's Boutique Residency with Heritage Commercial
                location. Premium finishes, modern amenities, and flexible
                payment options.
              </p>
            </motion.div>
          </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-4xl tracking-tight text-black sm:text-5xl">
                  Ready to Move 3 Bedroom Apartments
                </h2>
        ...
        {preLaunchApartments.length > 0 && (
          <section className="bg-white py-20">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-4xl tracking-tight text-black sm:text-5xl">
                  Pre-Launch 3 Bedroom Apartments
                </h2>
                <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
        ...
        <section className="bg-gray-100 py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl tracking-tight text-black sm:text-5xl">
                Why Choose 3 Bedroom Apartments in Bahria Town?
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <motion.div
              ...
              >
                ...
                <p className="text-gray-700">
                  Spacious 1,884-2,184 sq ft layouts provide ample space for
                  growing families with children. Dedicated dining, lounge, and
                  family areas.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-gray-700">
                  Gym, swimming pool, steam bath, prayer area, kids play area,
                  and 24/7 security with CCTV surveillance across all projects.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-gray-700">
                  Easy monthly installment options available on both ready and
                  pre-launch apartments. Down payment as low as 10%.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-gray-700">
                  Choose from Jinnah Avenue views, Safari views, Theme Park
                  views, or Heritage Club views. Every apartment offers stunning
                  vistas.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-gray-700">
                  Narkin's Builders has 30+ years of experience with completed
                  projects in Bahria Town. On-time delivery guaranteed.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-gray-700">
                  3 bedroom apartments in Bahria Town historically appreciate
                  well and offer excellent rental yields for investors.
                </p>
              </motion.div>
            </div>
          </div>
...
export const getStaticProps: GetStaticProps = async () => {
  try {
    const properties = getPropertiesByBedrooms(3)
